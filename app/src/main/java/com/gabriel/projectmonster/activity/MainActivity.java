...
public class MainActivity extends AppCompatActivity
    ...
    public static DSync bindToDSync(Context c){
        final DSync[] bound = new DSync[1];
        Intent i = new Intent(c, DSync.class);
        if(!DSync.isRunning()) c.startService(i);
        c.bindService(i, new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                bound[0] = ((DSync.DBinder) iBinder).getDataSyncService();
            }
